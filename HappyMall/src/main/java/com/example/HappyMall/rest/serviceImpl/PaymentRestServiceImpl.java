...
public class PaymentRestServiceImpl implements PaymentRestService {
	...
	public List<Payment> getAllPayments() {
		...
		ResponseEntity<Payment[]> responseEntity = restTemplate.exchange(serviceUrl, HttpMethod.GET, httpEntity,
				Payment[].class);
	...
	public Payment getPayment(int id) {
		...
		RestTemplate restTemplate = restHelper.getRestTemplate();
		HttpEntity httpEntity = new HttpEntity(restHelper.getHttpHeaders());
		ResponseEntity<Payment> responseEntity = restTemplate.exchange(serviceUrlExtended + id, HttpMethod.GET,
	...
	public List<Payment> getCustomerPayments(int id) {
		...
		RestTemplate restTemplate = restHelper.getRestTemplate();
		HttpEntity httpEntity = new HttpEntity(restHelper.getHttpHeaders());
		ResponseEntity<Payment[]> responseEntity = restTemplate.exchange(url, HttpMethod.GET, httpEntity,
				Payment[].class);
